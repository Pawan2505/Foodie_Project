<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Foodie_Project.Admin.Product" %>
                                                    ...
                                                    <div class="card-block">
                                                      <div class="row">
                                                        ...
                                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                                                ...
                                                                <div class="form-group">
                                                                   ...
                                                                   <div>
                                                                       <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control"
                                                                           placeholder="Enter ProductDescription" TextMode="MultiLine"></asp:TextBox>
                                                         ...
                                                         <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs" style="left: -1px; top: 1px">
