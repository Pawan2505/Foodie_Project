<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Foodie_Project.User.Registration" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvEmai" runat="server" ErrorMessage="Email is required " ControlToValidate="txtEmail"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
